...
INSERT INTO `webcars_db`.`endereco` (`estado`, `cidade`, `bairro`, `rua`) VALUES
...
INSERT INTO `webcars_db`.`concessionaria` (`nome_concessionaria`, `cnpj_concessionaria`, `email_concessionaria`, `telefone_concessionaria`, `imagem_concessionaria`, `endereco_id_endereco`) VALUES
...
INSERT INTO `webcars_db`.`cor` (`nome_cor`) VALUES
('Vermelho'),
('Azul'),
('Preto');

-- Populating the aro table
INSERT INTO `webcars_db`.`aro` (`nome_aro`) VALUES
('15'),
('16'),
('17');

-- Populating the categoria table
INSERT INTO `webcars_db`.`categoria` (`nome_categoria`) VALUES
('SUV'),
('Sedan'),
('Hatch');

-- Populating the marca table
INSERT INTO `webcars_db`.`marca` (`nome_marca`) VALUES
('Toyota'),
('Honda'),
('Ford');

-- Populating the modelo table
INSERT INTO `webcars_db`.`modelo` (`nome_modelo`, `marca_id_marca`, `categoria_id_categoria`) VALUES
('Corolla', 1, 2),
('Civic', 2, 2),
('Focus', 3, 3);

-- Populating the combustivel table
INSERT INTO `webcars_db`.`combustivel` (`nome_combustivel`) VALUES
('Gasolina'),
('Álcool'),
('Diesel');

-- Populating the cambio table
INSERT INTO `webcars_db`.`cambio` (`nome_cambio`) VALUES
('Manual'),
('Automático');

-- Populating the anuncioCarro table
INSERT INTO `webcars_db`.`anuncioCarro` (`nome_anuncioCarro`, `ano`, `condicao`, `valor`, `ipva_pago`, `data_ipva`, `data_compra`, `detalhes_veiculo`, `blindagem`, 
...
INSERT INTO `webcars_db`.`cliente` (`nome_cliente`, `cpf_cliente`, `email_cliente`, `telefone_cliente`, `imagem_cliente`) VALUES
...
INSERT INTO `webcars_db`.`filtroAlerta` (`nome_filtroAlerta`, `ano`, `condicao`, `ipva_pago`, `data_ipva`, `data_compra`, 
...
INSERT INTO `webcars_db`.`imagensCarro` (`nome_imagensCarro`,`anuncioCarro_id_anuncioCarro`) VALUES
('imagemA.jpg','1'),
('imagemB.jpg','2'),
('imagemC.jpg','3');
